...
![性能对比数据](../../assets/images/2020-11-13-Reflection-Method/20180227195855828)
...
泛型的多参数版本可以使用泛型类型生成器生成，我在 [生成代码，从 `` 到 `` —— 自动生成多个类型的泛型 - 吕毅](http://blog.csdn.net/WPwalter/article/details/79216183) 一文中写了一个泛型生成器，可以稍加修改以便适应这种泛型类。