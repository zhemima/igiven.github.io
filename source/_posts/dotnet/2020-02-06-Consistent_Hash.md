...
![简单架构](../../assets/images/2020-02-06-Consistent_Hash/3560038521-5c37267165ddf_articlex.png)
...
![哈希环](../../assets/images/2020-02-06-Consistent_Hash/1926833502-5c372671647ce_articlex.png)
整个空间按顺时针方向组织，0和2^32-1在零点中方向重合。

接下来，把服务器按照IP或主机名作为关键字进行哈希，这样就能确定其在哈希环的位置。
![哈希环2](../../assets/images/2020-02-06-Consistent_Hash/1992706399-5c37267165131_articlex.png)
然后，我们就可以使用哈希函数H计算值为key的数据在哈希环的具体位置h，根据h确定在环中的具体位置，从此位置沿顺时针滚动，遇到的第一台服务器就是其应该定位到的服务器。

例如我们有A、B、C、D四个数据对象，经过哈希计算后，在环空间上的位置如下：

![哈希环3](../../assets/images/2020-02-06-Consistent_Hash/2362548025-5c3726711599a_articlex.png)
...
![Redis2宕机](../../assets/images/2020-02-06-Consistent_Hash/2142503411-5c37267117f14_articlex.png)
...
![RedisServicee4](../../assets/images/2020-02-06-Consistent_Hash/1713186145-5c37267126a94_articlex.png)
...
![哈希环](../../assets/images/2020-02-06-Consistent_Hash/2099070812-5c37267114872_articlex.png)
...
![虚拟节点](../../assets/images/2020-02-06-Consistent_Hash/4164216256-5c3726711ca88_articlex.png)
